...
PIC_SWByEvent() {
  ...
  while true; do
    ...
    print_command "sudo ./idll-test.exe --external-sw 1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_External_Function_SW_Test"
    sudo ./idll-test.exe --external-sw 1 -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_External_Function_SW_Test
...
GetPortPin_BSEC() {
  ...
  while true; do
    #  sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section PIC_GetPICEvent_and_DisplayEventTime
    print_command "sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section GPI_BACC_FS"
