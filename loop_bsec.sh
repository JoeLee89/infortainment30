...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section User_LED
sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section User_LED
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section HighCurrent_LED
sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section HighCurrent_LED
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section GPO_LED
sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section GPO_LED
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section GPI_User_DIP_SW
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section GPI_Mainboard_DIP_SW
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section GPI_BACC_FS
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section GPO_LED_Drive
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test --LOOP 1 --SLAVE_ADDR 0x51 -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section ExtI2C
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test --LOOP 2 -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section Ext_SPI_RDID_REMS
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo ./idll-test --LOOP 2 -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section Crypto
#sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section Crypto_SHA
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#sudo ./idll-test --PORT_VAL 255 -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section HardMeter_BACC_SetPort
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test --LOOP 2 -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section SecMeter


# ===== PIC =====
# Test API : adiLibGetSystemInfo(SystemInfo* SysInfo);
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section PIC_Firmware_Version
#sudo ./idll-test --pic-fw 261  -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section PIC_Firmware_Version
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test --pic-time 2019/04/13/01/02/03 -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section PIC_RTC
...
sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section PIC_RTC
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section PIC_1Wire_EEPROM_Same_Pattern_0xA5
sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section PIC_1Wire_EEPROM_Random_Pattern
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section SRAM_Capacity
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section SRAM_Same_Pattern_0xA5
sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section SRAM_Random_Pattern
sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section SRAM_Performance