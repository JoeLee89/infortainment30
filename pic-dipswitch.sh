...
DipSwitch_GetPortPin() {
  ...
  while true; do
    print_command "sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section GPI_User_DIP_SW"
...
DipSwitch_GetportPin_BSEC() {
  ...
  while true; do
    print_command "sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_LEC1 --section GPI_Mainboard_DIP_SW"
