...
battery_alarm_event() {
  ...
  for ii in "oldest" "newest"; do
    ...
    print_command "sudo ./idll-test.exe --pic-batteries-voltage "33,33,33" -- --EBOARD_TYPE EBOARD_ADi_SC1X --section BatSetGetLowVoltageManual [PIC][BATTERY][MANU]"
    sudo ./idll-test.exe --pic-batteries-voltage "33,33,33" -- --EBOARD_TYPE EBOARD_ADi_SC1X --section BatSetGetLowVoltageManual [PIC][BATTERY][MANU]
...
rtc_alarm_event() {
  ...
  for ii in "oldest" "newest"; do
    ...
    for ((i = 0; i < 5; i++)); do
      sudo ./idll-test.exe --pic-alarm_seconds 2 -- --EBOARD_TYPE EBOARD_ADi_SC1X --section PIC_RTC_ALARM_SET_manual [PIC][RTC][ALARM][MANUAL]
...
queue_amount() {
  launch_command "sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_SC1X --section Callback_PIC_EventQueueFull_Auto [CALLBACK][PIC][UNITTEST]"
