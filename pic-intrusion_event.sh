...
IntruGetPort() {
  ...
  while true; do
    print_command "sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_Intrusion_ports"
    sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_Intrusion_ports
...
IntruCallback_Auto() {
  ...
  print_command "sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_Intrusion_Auto [CALLBACK][PIC][UNITTEST]"
  sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_Intrusion_Auto [CALLBACK][PIC][UNITTEST]
}
...
IntruCallback_Manual_3Mode() {
  ...
  for i in "OPEN" "CLOSE" "OPEN_OR_CLOSE"; do
      ...
      print_command "sudo ./idll-test.exe --pic-cb-intr-pinmask $target_dec --pic-cb-intr-event $i -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_Intrusion_Manu [CALLBACK][PIC][MANU]"
      sudo ./idll-test.exe --pic-cb-intr-pinmask $target_dec --pic-cb-intr-event $i -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_Intrusion_Manu [CALLBACK][PIC][MANU]
...
#  target_bin=$((target_bin>>1))
  ...
  printf "${COLOR_BLUE_WD}================================================= ${COLOR_REST}\n"
  launch_command "sudo ./idll-test.exe --pic-cb-intr-pinmask 0 --pic-cb-intr-event OPEN_OR_CLOSE -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_Intrusion_Manu [CALLBACK][PIC][MANU]"
