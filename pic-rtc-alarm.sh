...
PicEvent() {
  while true; do
    print_command "sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_GetPICEvent_and_DisplayEventTime"
    sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_GetPICEvent_and_DisplayEventTime
...
alarm_compare_set_get(){
    ...
    #==============================================================================
    print_command "sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_RTC_ALARM_GET_manual [PIC][RTC][ALARM][MANUAL]"
    picresult=$(sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_RTC_ALARM_GET_manual [PIC][RTC][ALARM][MANUAL] )
    echo "$picresult"
...
PicRtcAlarm(){
  ...
  while true; do
    ...
    print_command "sudo ./idll-test.exe --pic-alarm_seconds $key -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_RTC_ALARM_SET_manual [PIC][RTC][ALARM][MANUAL]"
    sudo ./idll-test.exe --pic-alarm_seconds $key -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_RTC_ALARM_SET_manual [PIC][RTC][ALARM][MANUAL]

    print_command "sudo ./idll-test.exe --rtc-alarm-conf $input -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_RTC_ALARM_CONF_SET_manual [PIC][RTC][ALARM][MANUAL]"
    sudo ./idll-test.exe --rtc-alarm-conf $input -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_RTC_ALARM_CONF_SET_manual [PIC][RTC][ALARM][MANUAL]
    ...
    launch_command "sudo ./idll-test.exe -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_RTC_ALARM_CONF_GET_manual [PIC][RTC][ALARM][MANUAL]"
...
PicRtcAlarm_Callback() {
  while true; do
    ...
    print_command "sudo ./idll-test.exe --rtc-alarm-conf $config --pic-alarm_seconds $time -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_RtcAlarm_Manual [CALLBACK][PIC][MANU]"
    sudo ./idll-test.exe --rtc-alarm-conf $config --pic-alarm_seconds $time -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_RtcAlarm_Manual [CALLBACK][PIC][MANU]
