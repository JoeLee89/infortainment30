...
SetWatchDogTimeOut() {
  ...
  if [[ "$timeout" -gt 100 ]]; then
    print_command "sudo ./idll-test.exe --watchdog $timeout -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_Watchdog"
    sudo ./idll-test.exe --watchdog $timeout -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_Watchdog
    ...
    for count in 0 10 100 200; do
      launch_command "sudo ./idll-test.exe --watchdog $count -- --EBOARD_TYPE EBOARD_ADi_SA3X --section PIC_Watchdog"
...
WatchDogCallback() {
  ...
  if [[ "$timeout" -gt 100 ]]; then
    ...
    launch_command "sudo ./idll-test.exe --WATCHDOG_TIMEOUT "$timeout" --SYSTEM_RESTART false -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_WDTimeout_Manual [CALLBACK][PIC][MANU]"
    ...
    for i in 0 1 10 100; do
      ...
      launch_command "sudo ./idll-test.exe --WATCHDOG_TIMEOUT $i --SYSTEM_RESTART false -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_WDTimeout_Manual [CALLBACK][PIC][MANU]"
...
loop_watchdog(){
  ...
  while true; do
    ...
    launch_command "sudo ./idll-test.exe --WATCHDOG_TIMEOUT 1 --SYSTEM_RESTART false -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_WDTimeout_Manual [CALLBACK][PIC][MANU]"
...
WatchDog_RestartSystem() {
  ...
  if [[ "$timeout" -ne 0 ]]; then
    print_command "sudo ./idll-test.exe --WATCHDOG_TIMEOUT $timeout --SYSTEM_RESTART true -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_WDTimeout_Manual [CALLBACK][PIC][MANU]"
    sudo ./idll-test.exe --WATCHDOG_TIMEOUT $timeout --SYSTEM_RESTART true -- --EBOARD_TYPE EBOARD_ADi_SA3X --section Callback_PIC_WDTimeout_Manual [CALLBACK][PIC][MANU]
  fi
