...
Crypto_Serial_ConigZone(){
  ...
  launch_command "sudo ./idll-test --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section Crypto"
}
...
CryptoEncode_SHA(){
  ...
  print_command "sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section Crypto_SHA"
  result1=$(printf $input | sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section Crypto_SHA)
  echo "$result1"
...
CryptoEncode_AES(){
  ...
  launch_command "sudo ./idll-test -- --EBOARD_TYPE EBOARD_ADi_BSEC_BACC --section Crypto_AES"
