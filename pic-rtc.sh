...
BadParameter() {
  ...
  read -p " " continue
  printf "${COLOR_RED_WD}sudo ./idll-test.exe --pic-time 2100/22/23/23/23/23 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_RTC  ${COLOR_REST}\n"
  sudo ./idll-test.exe --pic-time 2100/22/23/23/23/23 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_RTC
  sudo ./idll-test.exe --pic-time 2120/2/29/11/12/30 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section PIC_RTC
}
