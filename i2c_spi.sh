...
I2CSPI_Auto() {
  ...
  while true; do
    launch_command "sudo ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section ExtI2C"
    compare_result "$result" "passed"

    launch_command "sudo ./idll-test.exe --LOOP 1 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Ext_SPI_RDID_REMS"
...
I2CFreauency() {
  ...
  for all in 0 124 500 5000 65535; do
    ...
    launch_command "sudo ./idll-test.exe --I2C_PSCL $all -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Ext_I2C_BUS"
    hz=$((12500000/(all+1)))
  ...
  launch_command "sudo ./idll-test.exe --I2C_PSCL $i2c_freq -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Ext_I2C_BUS"
...
I2CWrite() {
  ...
  print_command "sudo ./idll-test.exe --SLAVE_ADDR 0x$i2caddr --I2C_CMD 0x00,0x00,0x01,0x02,0x03 --RESP_LEN 0 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Ext_I2C_EXEC"
  sudo ./idll-test.exe --SLAVE_ADDR 0x$i2caddr --I2C_CMD 0x00,0x00,0x01,0x02,0x03 --RESP_LEN 0 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Ext_I2C_EXEC
}
...
I2CRead() {
  ...
  print_command "sudo ./idll-test.exe --SLAVE_ADDR 0x$i2caddr --I2C_CMD 0x00,0x00 --RESP_LEN 3 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Ext_I2C_EXEC"
  sudo ./idll-test.exe --SLAVE_ADDR 0x$i2caddr --I2C_CMD 0x00,0x00 --RESP_LEN 3 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Ext_I2C_EXEC
}
...
SPIRead_RDID() {
  ...
  launch_command "sudo ./idll-test.exe --SPI_MODE 0 --SPI_CMD 0x9F --RESP_LEN 3 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Ext_SPI_EXEC"
...
SPIRead_REMS() {
  ...
  launch_command "sudo ./idll-test.exe --SPI_MODE 0 --SPI_CMD 0x90,0x00,0x00,0x00 --RESP_LEN 2 -- --EBOARD_TYPE EBOARD_ADi_"$board" --section Ext_SPI_EXEC"
